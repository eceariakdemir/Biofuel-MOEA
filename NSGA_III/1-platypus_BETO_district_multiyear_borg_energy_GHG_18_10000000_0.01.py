...
bg = 18 ## We will try 0, 3, 6, 9, 12, 15, 18, 20   biofuel gallon 
...
df_D = pd.DataFrame(D)
fn = 'Decision_Variables_borg_crops_GHG18_10000000_0.01' + version + '.csv'
df_D.to_csv(fn)

df_O = pd.DataFrame(O)
fn2 = 'Objective_functions_borg_crops_GHG18_10000000_0.01' + version + '.csv'
df_O.to_csv(fn2)
