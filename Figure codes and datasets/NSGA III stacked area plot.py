...
my_billion_list = ['3', '6', '9', '15', '18', '20']
...
for billion in my_billion_list:
    ...
    for v in version:
        ...
        fn_ha = 'NSGA_III decision variables ' + billion + v +'.csv'
        df_ha = pd.read_csv(fn_ha, header=0, index_col=0)
    
        fn = 'NSGA_III objective func ' + billion + v +'.csv'
        ...
        plt.savefig('Stack_graph_district_NSGA_III' + billion + v + '.png',dpi=150, bbox_inches='tight')
