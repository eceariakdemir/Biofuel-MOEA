...
###### STATE LEVE STACK GRAPH FOE FIGURE S7 #####
version = ['b 10M 0.001E']    
...
for billion in my_billion_list:
    ...
    for v in version:
        ...
        # import excel sheet
        df_geo_corn = pd.read_excel('State_Level_Platypus_codes/combined_pivot_Corn.xlsx', header=0, engine='openpyxl')
        df_geo_soy = pd.read_excel('State_Level_Platypus_codes/combined_pivot_Soy.xlsx', header=0, engine='openpyxl')
        df_geo_grass_L = pd.read_excel('State_Level_Platypus_codes/combined_pivot_AG_Switchgrass.xlsx', header=0, engine='openpyxl')
        df_geo_grass = pd.read_excel('State_Level_Platypus_codes/combined_pivot_ML_Switchgrass.xlsx', header=0, engine='openpyxl')
        df_geo_algae_L = pd.read_excel('State_Level_Platypus_codes/combined_pivot_AG_Algae.xlsx', header=0, engine='openpyxl')
        df_geo_algae = pd.read_excel('State_Level_Platypus_codes/combined_pivot_ML_Algae.xlsx', header=0, engine='openpyxl')
    

        fn_ha = 'State Level Borg decision variables ' + billion + v +'.csv'
        df_ha = pd.read_csv(fn_ha, header=0, index_col=0)

        fn = 'State Level Borg objective func ' + billion + v +'.csv'
        ...
        fig, ax = plt.subplots(1, figsize=(6.5, 5.3),constrained_layout = True)
        ...
        ax.stackplot(x, CC_corn, GG_grass, AA_algae, GG_grass_L, AA_algae_L, labels=[
                      'Corn/soy_AG', 'Grass_ML', 'Algae_ML', 'Grass_AG', 'Algae_AG'], colors=color_map)
   
        axis_fontsize = 14
        axis_fontsize = 14
        ax.set_ylabel('Total Fuel Production (MJ)')
        ax.set_xticks(np.arange(0, a, step=100), rotation=40)
        ax.grid(False)
        
        ax.set_title('State Level Sorted MFSP Solution',fontsize=14, fontweight="bold")
        plt.savefig('Stack_graph_district_Borg' + billion + v + '.png',dpi=150, bbox_inches='tight')


##### CLUSTERED LEVEL STACK GRAPH FOR FIG S7
version = ['b 10M 0.001E']    
...
for billion in my_billion_list:
    ...
    for v in version:
        ...
        # import excel sheet
        df_geo_corn = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_Corn.xlsx', header=0, engine='openpyxl')
        df_geo_soy = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_Soy.xlsx', header=0, engine='openpyxl')
        df_geo_grass_L = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_AG_Switchgrass.xlsx', header=0, engine='openpyxl')
        df_geo_grass = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_ML_Switchgrass.xlsx', header=0, engine='openpyxl')
        df_geo_algae_L = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_AG_Algae.xlsx', header=0, engine='openpyxl')
        df_geo_algae = pd.read_excel('Cluster_Level_Platypus_codes/combined_pivot_ML_Algae.xlsx', header=0, engine='openpyxl')
    

        fn_ha = 'Cluster Level Borg decision variables ' + billion + v +'.csv'
        df_ha = pd.read_csv(fn_ha, header=0, index_col=0)

        fn = 'Cluster Level Borg objective func ' + billion + v +'.csv'
        df_O = pd.read_csv(fn, header=0, index_col=0)
        ...
        ax.set_title('Cluster Level Sorted MFSP Solution',fontsize=14, fontweight="bold")
        plt.savefig('Stack_graph_district_Borg' + billion + v + '.png',dpi=150, bbox_inches='tight')



##### DISTRICT LEVEL STACK GRAPH FOR FIG S7
version = ['b 10M 0.001E']    
...
for billion in my_billion_list:
    ...
    for v in version:
        ...
        fn_ha = 'Borg decision variables ' + billion + v +'.csv'
        df_ha = pd.read_csv(fn_ha, header=0, index_col=0)

        fn = 'Borg objective func ' + billion + v +'.csv'
        df_O = pd.read_csv(fn, header=0, index_col=0)
        ...
        ax.set_title('District Level Sorted MFSP Solution',fontsize=14, fontweight="bold")
        plt.savefig('Stack_graph_district_Borg' + billion + v + '.png',dpi=150, bbox_inches='tight')
