...
for billion in my_billion_list:
    ...
    for v in version:
        ...
        fn_ha = 'NSGA_II decision variables ' + billion + v + '.csv'
        ...
        fn = 'NSGA_II objective func ' + billion + v +'.csv'
        ...
        plt.savefig('Stack_graph_district_NSGA_II' + billion + v + '.png',dpi=150, bbox_inches='tight')
